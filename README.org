...
* About Me
  ...
  I'm a machine learning engineer with a specialization in platform and infrastructure. I am
  currently a Staff ML Engineer at [[https://hinge.co/][Hinge]], where I was a founding member of the AI Platform Core
  team. My focus areas have been around: agentic systems; online model serving; and data/feature
  engineering for agentic AI and traditional ML.
...
* Writing
  ...
  - [[https://huggingface.co/learn/cookbook/index][Hugging Face Open-Source AI Cookbook]]: [[https://huggingface.co/learn/cookbook/en/mlflow_ray_serve]["Signature-Aware Model Serving from MLflow with Ray Serve"]]
