...
if(m.VIEW==m.INFO_VIEW){m.iV(d);m.ss(d);
...
a.CI.value=a.H[a.HI][0];}a.HI=(a.HI+1)%50;a.HBO=0;}else{if(a.HFO&&history.length){history.forward();
...
a.CI.value="";}else{a.SKIP_H=true;a.CI.value=a.H[a.HI][1];}a.HFO=0;}else{if(a.HBO&&history.length){history.back();
...
--b){if(this.HOOKS[a][b]==c){this.HOOKS[a].splice(b,1);}}}}};function OrgHtmlManagerLoadCheck(){org_html_manager.init();}
